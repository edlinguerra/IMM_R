...
El objetivo principal de este laboratorio es introducirlos a [R](https://www.r-project.org/) y [RStudio](https://rstudio.com/), las herramientas computacionales que utilizaremos a lo largo de este curso para aprender a aplicar los conceptos más importantes de *Análisis Multivariado con R*, pero en especial, para aprender a procesar y analizar datos reales.
